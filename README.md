...
## Kurulum (cPanel)
1. Proje dosyalarını `public_html` altına kopyalayın (dosyalar doğrudan kök dizinde çalışır).
...
## Geliştirme Notları
- Router basit bir yapıdadır. Yeni route eklemek için `index.php` dosyasını kullanın.
